...
FN_SEND_REQUEST(StandardSingleAttributesRequest, GETSINGLEATTRIBUTE_REQUEST);
FN_RECEIVE_RESPONSE(StandardSingleAttributesResponse, GETSINGLEATTRIBUTE_RESPONSE);

FN_SEND_REQUEST(StandardAggregatedAttributesRequest, GETAGGREGATEDATTRIBUTE_REQUEST);
FN_RECEIVE_RESPONSE(StandardAggregatedAttributesResponse, GETAGGREGATEDATTRIBUTE_RESPONSE);
