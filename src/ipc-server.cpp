...
FN_RECEIVE_REQUEST(StandardSingleAttributesRequest, GETSINGLEATTRIBUTE_REQUEST);
FN_SEND_RESPONSE(StandardSingleAttributesResponse, GETSINGLEATTRIBUTE_RESPONSE);

FN_RECEIVE_REQUEST(StandardAggregatedAttributesRequest, GETAGGREGATEDATTRIBUTE_REQUEST);
FN_SEND_RESPONSE(StandardAggregatedAttributesResponse, GETAGGREGATEDATTRIBUTE_RESPONSE);
